...
<li>
<a href="{{route('customer.filterBrands',$cat->id)}}" class="d-flex py-1 align-items-center">
<div class="flex-grow-1">
...
<form action="{{route('customer.filterPrice')}}" method="POST">
@csrf
<div class="card-body border-bottom">
...
<div class="mt-3">
<form action="{{route('customer.renting',$car->id)}}" method="POST">
@csrf
