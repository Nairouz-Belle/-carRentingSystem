...
<h4 class="card-title mb-0 flex-grow-1 text-danger"style="font-weight:bold;">@lang('messages.RENTING')</h4>
...
<select id="" class="form-select text-success" style="font-weight:bold;" name="user_id" required>


@foreach ($users as $user)
@if($user->type == "customer" && $user->id==auth()->user()->id)
...
<select id="" class="form-select text-info"style="font-weight:bold;" name="vehicule_id" readonly>
...
<input type="number" class="form-control text-success"style="font-weight:bold;" name="price"  value="{{$rent->price}}" readonly>
</div>
</div><!--end col-->
<div class="col-6">
<div class="mb-3">
<label for="" class="form-label">@lang('messages.Fine Per Day')</label>
<input type="number" class="form-control text-info"style="font-weight:bold;" name="fine" value="{{$rent->fine}}" readonly>
</div>
</div><!--end col-->
...
<input type="text" class="form-control text-warning"style="font-weight: bold;"name="status" value="Pending" readonly>
</div>
</div><!--end col-->
<div class="col-6">
<div class="mb-3">
