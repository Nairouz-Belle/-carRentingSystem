@extends('ManagerHome') @section('content')
        ...
        <div class="row">
            <div class="col">
                <div class="h-100">
                                ...
                                <div class="mt-3 mt-lg-0">
                                    <form action="javascript:void(0);">
                                        <div class="row g-3 mb-0 align-items-center">
                                            <!--end col-->
                                            <div class="col-auto">
                                                <a href="{{route('manager.vehicules.create')}}">
                    ...
                    $cvt=App\Models\Vehicule::where('transmission','=','CVT')->count(); $paymentsJanuary = DB::table('payments')->whereMonth('created_at', '01')->whereYear('created_at',$currentyear)->sum('amount');
                    $paymentsFebruary =DB::table('payments')->whereMonth('created_at', '02')->whereYear('created_at',$currentyear)->sum('amount'); $paymentsMarch = DB::table('payments')->whereMonth('created_at',
                    '03')->whereYear('created_at',$currentyear)->sum('amount'); $paymentsApril = DB::table('payments')->whereMonth('created_at', '04')->whereYear('created_at',$currentyear)->sum('amount'); $paymentsMay =
                    DB::table('payments')->whereMonth('created_at', '05')->whereYear('created_at',$currentyear)->sum('amount'); $paymentsJune = DB::table('payments')->whereMonth('created_at',
                    '06')->whereYear('created_at',$currentyear)->sum('amount'); $paymentsJuly = DB::table('payments')->whereMonth('created_at', '07')->whereYear('created_at',$currentyear)->sum('amount'); $paymentsAugust =
                    DB::table('payments')->whereMonth('created_at', '08')->whereYear('created_at',$currentyear)->sum('amount'); $paymentsSeptember= DB::table('payments')->whereMonth('created_at',
                    '09')->whereYear('created_at',$currentyear)->sum('amount'); $paymentsOctober = DB::table('payments')->whereMonth('created_at', '10')->whereYear('created_at',$currentyear)->sum('amount'); $paymentsNovember =
                    DB::table('payments')->whereMonth('created_at', '11')->whereYear('created_at',$currentyear)->sum('amount'); $paymentsDecember = DB::table('payments')->whereMonth('created_at',
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            ...
                                            <a href="{{route('manager.payments.index')}}" class="text-decoration-underline text-success">@lang('messages.View Earnings')</a>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            ...
                                            <a href="{{route('manager.reservations.index')}}" class="text-decoration-underline text-info">@lang('messages.View all orders')</a>
                                        </div>
                                        <div class="avatar-sm flex-shrink-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            ...
                                            <a href="{{route('manager.users.index')}}" class="text-decoration-underline text-danger">@lang('messages.See details')</a>
                                        </div>
                                        <div class="avatar-sm flex-shrink-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            ...
                                            <a href="{{route('manager.vehicules.index')}}" class="text-decoration-underline text-muted">@lang('messages.View Vehicles')</a>
                                        </div>
                                        <div class="avatar-sm flex-shrink-0">
                                                            ...
                                                            <td style="display: none;">
                                                                ...
                                                                <div class="btn-group">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item text-success" style="font-weight: bold;" href="{{route('manager.confirmed',$usr->id)}}">@lang('messages.Confirmed')</a>
                                                                        <div class="dropdown-divider"></div>
                                                                        <a class="dropdown-item text-danger" style="font-weight: bold;" href="{{route('manager.blocked',$usr->id)}}">@lang('messages.Blocked')</a>
                                                                    </div>
                                                                </div>
                                                                <!-- /btn-group -->
                                                            </td>
                                                            ...
                                                            <td style="display: none;">
                                                                <div class="dropdown d-inline-block">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                        <li>
                                                                            <a href="{{route('manager.users.show',$usr->id)}}" class="dropdown-item"><i class="ri-eye-fill align-bottom me-2 text-muted"></i>@lang('messages.View')</a>
                                                                        </li>
                                                                        <li>
                                                                            <a class="dropdown-item edit-item-btn" href="{{route('manager.users.edit',$usr->id)}}">
                                                                                <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> @lang('messages.Edit')
                                                                            </a>
                                                                        </li>
                                                                        <li>
                                                                            <a class="dropdown-item">
                                                                                <form method="POST" action="{{route('manager.users.destroy',$usr->id)}}">
                                                                                    @csrf
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="odd">
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a class="dropdown-item text-warning" style="font-weight: bold;" href="{{route('manager.onRent',$res->id)}}">@lang('messages.On Rent')</a>
                                                                    <div class="dropdown-divider"></div>

                                                                    <a class="dropdown-item text-secondary" style="font-weight: bold;" href="{{route('manager.reservation.confirmed',$res->id)}}">@lang('messages.Confirmed')</a>
                                                                    <div class="dropdown-divider"></div>

                                                                    <a class="dropdown-item text-danger" style="font-weight: bold;" href="{{route('manager.cancelled',$res->id)}}">@lang('messages.Cancelled')</a>
                                                                </div>
                                                            </td>
                                                            <td>{{$res->borrow}}</td>
                                                            <td>{{$res->return}}</td>
                                                            ...
                                                            <td>
                                                                <div class="dropdown d-inline-block">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                                        <li>
                                                                            <a href="{{route('manager.reservations.show',$res->id)}}" class="dropdown-item"><i class="ri-printer-line align-bottom me-2 text-muted"></i>@lang('messages.Print')</a>
                                                                        </li>
                                                                        <li>
                                                                            <a class="dropdown-item edit-item-btn" href="{{route('manager.reservations.edit',$res->id)}}">
                                                                                <i class="ri-pencil-fill align-bottom me-2 text-muted"></i>@lang('messages.Edit')
                                                                            </a>
                                                                        </li>
                                                                        <li>
