...
<meta charset="utf-8" />
<title>@lang('messages.Create Vehicule')</title>
...
<form action="{{route('manager.vehicules.store')}}" method="POST" id="createproduct-form" autocomplete="off" class="needs-validation" enctype="multipart/form-data" novalidate>
@csrf
<div class="row">
<div class="col-lg-8">
<div class="card">
