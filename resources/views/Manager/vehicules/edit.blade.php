...
<form action="{{route('manager.vehicules.update',$vehicule->id)}}" method="POST" enctype="multipart/form-data" id="createproduct-form" autocomplete="off" class="needs-validation" novalidate>
@csrf
@method('PUT')
<div class="row">
<div class="col-lg-8">
...
<input id="profile-img-file-input" name="carPic" type="file" value="{{$vehicule->carPic}}"class="profile-img-file-input" accept="image/png, image/jpeg">
