...
<li>
<a href="{{route('manager.filterBrands',$cat->id)}}" class="d-flex py-1 align-items-center">
<div class="flex-grow-1">
...
<form action="{{route('manager.filterPrice')}}" method="POST">
@csrf
<div class="card-body border-bottom">
...
<form action="{{route('manager.filter')}}" method="POST">
@csrf 
...
<a href="{{route('manager.vehicules.create')}}" class="btn btn-info"><i class="ri-add-line align-bottom me-1" id="addproduct-btn"></i> @lang('messages.Add Vehicle')</a>
</div>
</div>
<div class="col-sm">
<div class="d-flex justify-content-sm-end">
<div class="search-box ms-2">
<input type="text" class="form-control" id="searchProductList" placeholder="@lang('messages.Search Vehicle')"wire:model="search" >
...
<a href="{{route('manager.vehicules.show',$car->id)}}" class="btn btn-primary">
<i class="ri-eye-fill">
</i>
</a>
<a href="{{route('manager.vehicules.edit',$car->id)}}" class="btn btn-success">
<i class="ri-edit-fill">
</i>
</a>
<a class="btn btn-danger">

<form method="POST" action="{{route('manager.vehicules.destroy',$car->id)}}" >
@csrf
...
<div class="mt-3">
<form action="{{route('manager.renting',$car->id)}}" method="POST">
@csrf
