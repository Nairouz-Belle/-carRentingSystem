                                ...
                                <div class="card-body">
                                    ...
                                    <div class="explore-place-bid-img overflow-hidden rounded">
                                        ...
                                        <div class="place-bid-btn" style="display: flex;">
                                                ...
                                                <a href="{{route('manager.category.edit',$brand->id)}}" class="btn btn-info"><i class="ri-edit-fill align-bottom me-1"></i>
                                                </a>
                ...
                <div class="modal fade" id="showModal" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <form  action="{{route('manager.category.store')}}" method="POST" class="tablelist-form" enctype="multipart/form-data"  autocomplete="off">
                                                  @csrf
                                                            ...
                                                            <div class="text-center">
                                                              ...
                                                              <div class="profile-user position-relative  d-inline-block mx-auto mb-4">
                                                                    ...
                                                                    <div class="avatar-xs p-0 rounded-circle profile-photo-edit">
                                                                        <input name="image" id="profile-img-file-input" type="file" class="profile-img-file-input" required>
