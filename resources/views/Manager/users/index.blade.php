        ...
        <ul class="nav nav-tabs nav-tabs-custom nav-success mb-3" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link py-3 Delivered" data-bs-toggle="tab" id="Delivered" href="#delivered" role="tab" aria-selected="false">
                    <i class="ri-checkbox-circle-line me-1 align-bottom"></i> Active<span class="badge bg-success align-middle ms-1">{{$active}}</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link py-3 Pickups" data-bs-toggle="tab" id="Pickups" href="#pickups" role="tab" aria-selected="false">
                    <i class="ri-close-circle-line me-1 align-bottom"></i> Blocked <span class="badge bg-danger align-middle ms-1">{{$blocked}}</span>
                </a>
            </li>
        </ul>
...
<div class="tab-content">
    <div class="tab-pane fade show active" id="home1" role="tabpanel">
        <div class="row">
          <div class="tab-content text-muted">
            <div class="tab-pane active show" id="border-navs-home" role="tabpanel">
            <div class="d-flex">
            <div class="row">
                
                    <div class="card-body">
                        <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle col-lg-12"style="width:110%;">
                        <thead>
                        <tr>
                        ...
                        @else
                        <td style="display: none;">
                        <span class="badge bg-danger">{{$usr->status}}
                        ...
                        <li>
                        <a class="dropdown-item edit-item-btn" href="{{route('manager.users.edit',$usr->id)}}"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i>@lang('messages.Edit')</a>
                        </li>
                        <li>
    ...
    <div class="tab-pane fade" id="pickups" role="tabpanel">
        <div class="row">
          <div class="tab-content text-muted">
            <div class="tab-pane active show" id="border-navs-home" role="tabpanel">
            <div class="d-flex">
            <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <tbody>
                        @foreach($users as $usr)
                        @if(($usr->type=="customer")&&($usr->status=="Blocked"))    
                        <tr class="odd">
                        <th scope="row" class="dtr-control sorting_1" tabindex="0">
                        <div class="form-check">
    ...
    <form  action="{{route('manager.users.store')}}" method="POST" class="tablelist-form" enctype="multipart/form-data"  autocomplete="off">
    @csrf
    ...
    <button type="submit" class="btn btn-success" id="add-btn">@lang('messages.Add Customer')</button>
