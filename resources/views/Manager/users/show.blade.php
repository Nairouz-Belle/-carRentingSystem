    ...
    <a href="{{route('manager.users.edit',$user->id)}}" class="btn btn-light"><i class="ri-edit-box-line align-bottom"></i>@lang('messages.Edit Profile')</a>
    </div>
    </div>
    <!-- Tab panes -->
    @php
    ...
    <tr>
    <th class="ps-0" scope="row">@lang('messages.Mobile') :</th>
    ...
    <th data-ordering="false" class="sorting sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" style="width: 43.6px;" aria-label="SR No.: activate to sort column descending" aria-sort="ascending">Reservation No.</th>
