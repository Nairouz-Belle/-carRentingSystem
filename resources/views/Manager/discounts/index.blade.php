...
<a class="dropdown-item text-danger" style="font-weight: bold;" href="{{route('manager.disactivate',$dis->id)}}">@lang('messages.Disactivate')</a>
...
<li>
<a class="dropdown-item edit-item-btn" href="{{route('manager.discounts.edit',$dis->id)}}"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i>@lang('messages.Edit')</a></li>
<li>
<a class="dropdown-item">

<form method="POST" action="{{route('manager.discounts.destroy',$dis->id)}}">
@csrf
...
<form  action="{{route('manager.discounts.store')}}" method="POST" class="tablelist-form" enctype="multipart/form-data"  autocomplete="off">
@csrf
