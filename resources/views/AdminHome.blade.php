            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="">
                                <i class="ri-user-2-line"></i> <span data-key="t-authentication">Managers</span>
                            </a>
        ...
        <div class="main-content">
            ...
            <footer class="footer">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6">
                            <script>document.write(new Date().getFullYear())</script>Car Rental © All Rights Are resurved 2023.
                        </div>
                    </div>
                </div>
            </footer>
