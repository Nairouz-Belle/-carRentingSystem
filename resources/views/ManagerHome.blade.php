...
<head>
    ...
    <meta charset="utf-8" />
    <title> @lang('messages.Car Rental') | @lang('messages.Manager Dashboard') </title>
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                  ...
                  @endforeach
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="{{route('manager.users.edit',(Auth::user()->id))}}"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profile</span></a>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{route('manager.home')}}">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="{{route('manager.company.index')}}">
