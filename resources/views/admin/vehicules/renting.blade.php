...
<h4 class="mb-sm-0 text-danger">@lang('messages.Vehicle')</h4>
...
<h4 class="card-title mb-0 flex-grow-1 text-info"><i class="ri-edit-box-line text-info"></i> @lang('messages.RENTING')</h4>
...
<div class="col-6">
<div class="mb-3">
<label for="" class="form-label">@lang('messages.Customer') <b class="text-danger" >*</b></label>
...
<div class="col-6">
<div class="mb-3">
<label for="" class="form-label">@lang('messages.Vehicle') <b class="text-danger" >*</b></label>
...
<div class="col-6">
<div class="mb-3">
<label for="firstNameinput" class="form-label" >@lang('messages.Pick up Date') <b class="text-danger" >*</b></label>
<input type="date" class="form-control" name="borrow" required>
</div>
</div><!--end col-->
<div class="col-6">
<div class="mb-3">
<label for="" class="form-label">@lang('messages.Drop off Date') <b class="text-danger" >*</b></label>
<input type="date" class="form-control" name="return" required >
</div>
</div><!--end col-->
<div class="col-6">
<div class="mb-3">
<label for="" class="form-label">@lang('messages.Price') <b class="text-danger" >*</b></label>
<input type="number" class="form-control" name="price"  value="{{$rent->price}}" readonly>
</div>
</div><!--end col-->
<div class="col-6">
<div class="mb-3">
<label for="" class="form-label">@lang('messages.Fine Per Day') <b class="text-danger" >*</b></label>
<input type="number" class="form-control" name="fine" value="{{$rent->fine}}" readonly>
</div>
</div><!--end col-->
<div class="col-6"style="display: none;">
<div class="mb-3">
<label for="" class="form-label">@lang('messages.Returned') <b class="text-danger" >*</b></label>
...
<select class="form-select text-success" name="status" style="font-weight:bold;">
	
	<option class="text-primary" style="font-weight:bold;" value="Confirmed" selected>Confirmed</option>
