...
<form  action="{{route('Company.store')}}" method="POST" class="tablelist-form" enctype="multipart/form-data"  autocomplete="off">
@csrf
...
<input type="text"placeholder="Site Web" name="siteweb" class="form-control" required />
</div>
</div>
</div>
...
@foreach($companies as $company)
 ...
 <div class="col-xxl-6">
	...
	<ul class="list-inline mb-0">
		...
		<li class="list-inline-item avatar-xs">
		<a href="{{route('Company.edit',$company->id)}}" class="avatar-title bg-soft-success text-success fs-15 rounded">
